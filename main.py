...
# --- CORRECCIÓN: OPERACIONES UNARIAS APLICADAS AL FACTOR (FUNCIONES/VARIABLES) ---
def p_factor_nested(p):    '''factor : OPEN_PAR expresion CLOSE_PAR'''
def p_factor_unary_sum(p): '''factor : OP_SUM factor'''
def p_factor_unary_min(p): '''factor : OP_MINUS factor'''  # <- Antes decia 'base', ahora 'factor'
...
if __name__ == '__main__':
    ...
    if os.path.exists(nombre_archivo):
        ...
        print(f"[!] Archivo '{nombre_archivo}' no encontrado. Por favor crealo con tu codigo de prueba.")